...
| frontLightIcon.qmd | myself | Displays a small icon in the upper right-hand corner whenever front light is enabled and toolbar is hidden. | Might ruin the minimalitic design if you use front light often. |
